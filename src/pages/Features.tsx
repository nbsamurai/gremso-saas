...
export default function Features() {
  return (
    <InfoPageLayout
      title="Features"
      intro="Gremso is built for construction teams that need one dependable place to manage projects, documents, meetings, and operational updates."
      paragraphs={[
        ...
        'Gremso also supports secure document handling, structured team access, and workspace-level organization so growing companies can scale their delivery process without losing visibility or control.',
      ]}
    />
  );
}
